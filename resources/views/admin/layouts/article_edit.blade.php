...
<div class="container">
    ...
    <form action="{{ route('article.update', $article->id) }}" method="POST" class="mt-3">
        @csrf
        @method('PUT')
        ...
        <div class="form-group mt-3">
            ...
            <textarea name="article_content" id="article_content" class="form-control" required>{{ $article->article_content }}</textarea>
        </div>
